...
export default function DesignShowcase() {
    ...
    return (
        ...
        >
            ...
            {/* Page Header */}
            <div className="mb-8">
                <h1 className="text-3xl text-navy font-bold">Design System</h1>
                <p className="text-platinum-dark mt-1">NEOA Brand — Component Library Preview</p>
            </div>
            ...
            <motion.div variants={staggerContainer} initial="initial" animate="animate" className="space-y-10">
                ...
                <motion.section variants={staggerItem}>
                    <h2 className="text-xl text-navy font-semibold mb-4 border-b border-platinum pb-2">Buttons</h2>
                ...
                {/* ══════ INPUTS ══════ */}
                <motion.section variants={staggerItem}>
                    <h2 className="text-xl text-navy font-semibold mb-4 border-b border-platinum pb-2">Inputs</h2>
                ...
                {/* ══════ BADGES ══════ */}
                <motion.section variants={staggerItem}>
                    <h2 className="text-xl text-navy font-semibold mb-4 border-b border-platinum pb-2">Badges</h2>
                ...
                {/* ══════ CARDS ══════ */}
                <motion.section variants={staggerItem}>
                    <h2 className="text-xl text-navy font-semibold mb-4 border-b border-platinum pb-2">Cards</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <Card hover>
                            <div className="h-32 bg-gradient-to-br from-navy to-navy-light rounded-lg mb-4 flex items-center justify-center">
                                <ShieldCheck className="w-10 h-10 text-gold" />
                            </div>
                            <h3 className="text-lg font-semibold text-navy">Escrow Protected</h3>
                        ...
                        <Card hover>
                            <div className="h-32 bg-gradient-to-br from-emerald to-emerald-light rounded-lg mb-4 flex items-center justify-center">
                                <CreditCard className="w-10 h-10 text-white" />
                            </div>
                            <h3 className="text-lg font-semibold text-navy">Payment Ready</h3>
                            <p className="text-sm text-platinum-dark mt-1">Connected to Paystack and Wise for dual-rail payouts.</p>
                            <Card.Footer>
                                <div className="flex justify-between items-center">
                                    <span className="text-lg font-bold text-emerald">₦45,000</span>
                        ...
                        <Card hover>
                            <div className="h-32 bg-gradient-to-br from-gold-dark to-gold-light rounded-lg mb-4 flex items-center justify-center">
                                <Truck className="w-10 h-10 text-white" />
                            </div>
                            <h3 className="text-lg font-semibold text-navy">In Transit</h3>
                ...
                {/* ══════ STEP TRACKER ══════ */}
                <motion.section variants={staggerItem}>
                    <h2 className="text-xl text-navy font-semibold mb-4 border-b border-platinum pb-2">Order Progress Tracker</h2>
                    <Card>
                ...
                {/* ══════ SKELETONS ══════ */}
                <motion.section variants={staggerItem}>
                    <h2 className="text-xl text-navy font-semibold mb-4 border-b border-platinum pb-2">Skeleton Loaders</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <Skeleton.Card />
                        <Skeleton.Card />
                        <Skeleton.Card />
                ...
                {/* ══════ MODAL + TOAST ══════ */}
                <motion.section variants={staggerItem}>
                    <h2 className="text-xl text-navy font-semibold mb-4 border-b border-platinum pb-2">Modal & Toast</h2>
